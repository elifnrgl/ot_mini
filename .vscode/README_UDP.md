...
Soketi belirli bir IP adresi ve porta bağlar (dinlemeye alır).
...
Otomatik Bind Mantığı: Eğer kullanıcı soketi daha önce bind etmediyse, kod burada devreye girer: Soketi otomatik olarak RandomEphemeralPort() ile rastgele bir porta bind eder.
